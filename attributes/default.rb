...
<<<<<<< HEAD
default['haskell']['cabal']['configure_options'] = "--prefix=#{haskell['cabal']['prefix_dir']} GHC=#{haskell['cabal']['ghc']} GHC_PKG=#{haskell['cabal']['ghc_pkg']}"
=======
default['haskell']['cabal']['configure_options'] = "PREFIX=#{haskell['cabal']['prefix_dir']} GHC=#{haskell['cabal']['ghc']} GHC_PKG=#{haskell['cabal']['ghc_pkg']}"
>>>>>>> 56ecb8ba5498c71468ea199a6981ae4415881e61
